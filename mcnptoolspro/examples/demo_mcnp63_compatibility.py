...
# Test files (MCNP 6.3)
test_files = {
    'none': '../tests/test_data/ptrac63_filter_none.ip',
    'event': '../tests/test_data/ptrac63_filter_event.ip',
    'type': '../tests/test_data/ptrac63_filter_type.ip',
    'filter': '../tests/test_data/ptrac63_filter_filter.ip',
    'tally': '../tests/test_data/ptrac63_filter_tally.ip',
    'all': '../tests/test_data/ptrac63_filter_all.ip',
}
